  ...
  return (
    <main className="flex min-h-[100dvh] flex-col items-center justify-between p-4 sm:p-8 md:p-16 lg:p-24">
      ...
      <div className="flex flex-col items-center gap-4">
        <테스트보기Button />
        <div className="grid gap-2 p-2 max-h-80 sm:max-h-60 md:max-h-40 overflow-x-auto border rounded-lg text-sm text-slate-700 bg-white/50">
          <p>
            본 테스트는 BDSM에 대한 지식과 이해도를 검증하기 위한 목적으로 제작되었습니다. 테스트 문항 중에는 성적
            행위와 관련된 내용이 포함되어 있을 수 있음을 알려 드립니다. 각 문항은 성인 대상의 성적 표현과 테마를 다루고
            있으며, 이러한 내용에 대해 민감하거나 불편함을 느끼는 분들에게는 이 테스트가 적합하지 않을 수 있습니다. 모든
            참여자는 본인의 편안함과 준비 상태를 고려하여 테스트 참여를 결정하시기 바랍니다.
          </p>
          <p>
          ...
          <p>
            ...
            도움을 주는 참고 자료일 뿐입니다. 결과에 대해 과도한 의미 부여나 일반화를 하지 않으시기 바라며, 개인의 성향,
            경험, 지식 등을 고려하는 것이 중요합니다. 본 테스트를 활용하거나 참고하여 발생한 어떠한 문제에 대해서도
            테스트 제공자는 책임을 지지 않습니다. 모든 책임과 결과는 테스트를 이용한 당사자에게 있으며, 안전과 책임감을
            가지고 테스트를 활용하시기 바랍니다.
          </p>
        </div>
      </div>
